...
# The support bundle must only contact the local redacted diagnostics endpoint.
# This prevents the environment override from turning the collector into an SSRF helper.
case "$DIAG_URL" in
