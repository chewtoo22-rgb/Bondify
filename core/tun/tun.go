// Package tun provides HYDRA's cross-platform virtual network interface abstraction.
//
...
// vectorized Read/Write interface. This package just re-exports it under HYDRA's own name
...
// asked for. HYDRA doesn't want or need GRO/GSO here (packets are already
