...
Risk: support artifacts leak keys, session identifiers, addresses, or decrypted user traffic; an unauthenticated diagnostics listener becomes remotely reachable.
...
- remote diagnostics require an explicit future authentication/TLS design, not a relaxed bind check.
