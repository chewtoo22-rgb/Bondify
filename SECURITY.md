...
- release checksums, provenance attestations, least-privilege publishing, a guard preventing debug Android APKs from being published as production releases, and a tag-lineage guard requiring tag-triggered releases to point at commits already contained in `main`.
